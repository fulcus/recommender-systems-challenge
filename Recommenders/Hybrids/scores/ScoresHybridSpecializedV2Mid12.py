...
class ScoresHybridSpecializedV2Mid12(BaseItemSimilarityMatrixRecommender):
    """ ItemKNNScoresHybridRecommender
    Hybrid of two prediction scores R = R1*alpha + R2*(1-alpha)
    NB: Rec_1 is itemKNNCF, Rec_2 is userKNNCF
    """

    RECOMMENDER_NAME = "ScoresHybridSpecializedV2Mid12"

    def __init__(self, URM_train, ICM_train):
        super(ScoresHybridSpecializedV2Mid12, self).__init__(URM_train)
    ...
    def recommend(self, user_id_array, cutoff=None, remove_seen_flag=True, items_to_compute=None,
        ...
        res = super(ScoresHybridSpecializedV2Mid12, self).recommend(user_id_array, cutoff=cutoff, remove_seen_flag=remove_seen_flag,
